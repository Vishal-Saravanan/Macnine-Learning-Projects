...
ui,_=loadUiType('face recognition.ui')
...
### LOGIN PROCESS ###
    ...
    def show_reports_form(self):
        ...
        r=0
        c=0
        for row_number,row_data in enumerate(result):  # Looping throught the data to write data in reports
            r+=1
            c=0
    ...
    def show_selected_date_reports(self):
        ...
        self.REPORTS.setHorizontalHeaderLabels(['Id','Name','Date'])        
        self.REPORTS.setColumnWidth(0,30)
